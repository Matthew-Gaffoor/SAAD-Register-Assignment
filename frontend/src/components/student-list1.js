    ...
    <main>
      ...
      <section class="py-5 text-center container">
        <div class="row py-lg-5">
          <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Student List SAaD @ 08:00 GMT </h1>
      ...
      <div class="album py-5 bg-light">
        ...
        <div class="row mb-3 text-center">
            ...
            <div class="col-4 col-sm-2 themed-grid-col">Software Engineering</div>
            <div class="col-4 col-sm-2 themed-grid-col">Software Architecture and Design</div>
            <div class="col-4 col-sm-2 themed-grid-col">08:00 GMT</div>
            <div class="col-4 col-sm-2 themed-grid-col"><button type="button" class="btn btn-sm btn-outline-secondary" onClick={() => {navigate("/student-remove")}}>Remove</button></div>
        </div>
        <div class="row mb-3 text-center">
...
export default ViewStudentList1;