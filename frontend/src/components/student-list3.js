    ...
    <main>
      ...
      <section class="py-5 text-center container">
        <div class="row py-lg-5">
          <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Student List MOiP @ 13:00 GMT</h1>
      ...
      <div class="album py-5 bg-light">
        ...
        <div class="row mb-3 text-center">
            ...
            <div class="col-4 col-sm-2 themed-grid-col">Management Of It Projects</div>
            <div class="col-4 col-sm-2 themed-grid-col">13:00 GMT</div>
        ...
        <div class="row mb-3 text-center">
            ...
            <div class="col-4 col-sm-2 themed-grid-col">Software Engineering</div>
            <div class="col-4 col-sm-2 themed-grid-col">Management Of It Projects</div>
            <div class="col-4 col-sm-2 themed-grid-col">13:01 GMT</div>
            <div class="col-4 col-sm-2 themed-grid-col"><button type="button" class="btn btn-sm btn-outline-secondary">Remove</button></div>
        </div>
        </div>
      </div>
...
export default ViewStudentList3;